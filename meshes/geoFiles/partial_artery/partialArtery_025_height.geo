...
Point(0) = {0, 0, 0.25, h};
Point(1) = {1.25, 0, 0, h};
Point(2) = {1.25, 0, 0.25, h};
Point(3) = {0, 1.25, 0.25, h};
Point(4) = {0, 1.25, 0, h};
Point(5) = {0, 1, 0, h};
Point(6) = {0, 1, 0.25, h};
Point(7) = {1, 0, 0.25, h};
...
//Transfinite Line{3,4}=0.5708 / h +4; //Number of points on a 1/4 of inner circle length: 0.5708
//Transfinite Line{6,8,9,11}= 0.25 / h +1; // short side - depth
//Transfinite Line{5,7,10,12}=0.5 /h +3;      // long side - heigth
