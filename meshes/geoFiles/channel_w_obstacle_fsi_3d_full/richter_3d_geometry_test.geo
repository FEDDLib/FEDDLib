...
// Physical surfaces
//+
Physical Surface("1") = {201, 206, 205, 202, 212};
//+
Physical Surface("2") = {203};
//+
Physical Surface("3") = {204};
//+
Physical Surface("5") = {207, 209, 208, 210, 211};
//+
Physical Volume("10") = {402};
//+
Physical Volume("10") += {401};
//+
Compound Surface {209, 211, 212, 210, 208, 207};
