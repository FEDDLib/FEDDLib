...
int main(int argc, char *argv[])
{
...

    {
       ...
       // ########################
        ...
        // Boundary conditiona
        // ########################
        Teuchos::RCP<BCBuilder<SC,LO,GO,NO> > bcFactory( new BCBuilder<SC,LO,GO,NO>( ) ); // general
            
        Teuchos::RCP<BCBuilder<SC,LO,GO,NO> > bcFactoryChem( new BCBuilder<SC,LO,GO,NO>( ) ); // chem
               
        Teuchos::RCP<BCBuilder<SC,LO,GO,NO> > bcFactoryStructure( new BCBuilder<SC,LO,GO,NO>( ) ); // structure
        ...
        errorValues->update( 1., solReadConst, -1. ,solConst, 0.);
