...
template<class SC,class LO,class GO,class NO>
void ExporterParaViewAMR<SC,LO,GO,NO>::setup(std::string filename,
                                          MeshPtr_Type mesh,
                                          std::string FEType,
                                          int saveTimestep,
...
//template<class <<<<SC,class LO,class GO,class NO>
//void ExporterParaViewAMR<SC,LO,GO,NO>::setup(int dim,
//                                          GO nmbElementsGlob,
...
template<class SC,class LO,class GO,class NO>
void ExporterParaViewAMR<SC,LO,GO,NO>::addVariable(MultiVecConstPtr_Type &u,
                                                  std::string varName,
                                                  std::string varType,
                                                  int dofPerNode,
                                                  MapConstPtrConst_Type& mapUnique,
...
template<class SC,class LO,class GO,class NO>
void ExporterParaViewAMR<SC,LO,GO,NO>::save(double time){
...
template<class SC,class LO,class GO,class NO>
void ExporterParaViewAMR<SC,LO,GO,NO>::save(double time, double dt){
...
template<class SC,class LO,class GO,class NO>
void ExporterParaViewAMR<SC,LO,GO,NO>::closeExporter(){
...
template<class SC,class LO,class GO,class NO>
void ExporterParaViewAMR<SC,LO,GO,NO>::initHDF5(){
...
template<class SC,class LO,class GO,class NO>
void ExporterParaViewAMR<SC,LO,GO,NO>::writeMeshPointsHDF5(){
    if (!parameterList_.is_null()){
        if ( parameterList_->sublist("Exporter").get("Write new mesh",false) ) {
            updatePoints();
...
template<class SC,class LO,class GO,class NO>
void ExporterParaViewAMR<SC,LO,GO,NO>::writeMeshElements( std::string nameConn ){
...
template<class SC,class LO,class GO,class NO>
void ExporterParaViewAMR<SC,LO,GO,NO>::writeMeshPoints(std::string nameP_X,
                                                    std::string nameP_Y,
                                                    std::string nameP_Z){
...
template<class SC,class LO,class GO,class NO>
void ExporterParaViewAMR<SC,LO,GO,NO>::updatePoints(){
    int dim = -1;
...
template<class SC,class LO,class GO,class NO>
void ExporterParaViewAMR<SC,LO,GO,NO>::writeVariablesHDF5(){
...
template<class SC,class LO,class GO,class NO>
void ExporterParaViewAMR<SC,LO,GO,NO>::initXmf(){
...
template<class SC,class LO,class GO,class NO>
void ExporterParaViewAMR<SC,LO,GO,NO>::initXmfTimes(){
    writeDt_ = true;
    if (comm_->getRank()==0) {
...
template<class SC,class LO,class GO,class NO>
void ExporterParaViewAMR<SC,LO,GO,NO>::writeXmf(double time){
...
template<class SC,class LO,class GO,class NO>
void ExporterParaViewAMR<SC,LO,GO,NO>::writeXmfElements( std::string nameConn, double time ){
...
template<class SC,class LO,class GO,class NO>
void ExporterParaViewAMR<SC,LO,GO,NO>::writeXmfPoints(std::string nameP_X,
                                                   std::string nameP_Y,
                                                   std::string nameP_Z ){
...
template<class SC,class LO,class GO,class NO>
void ExporterParaViewAMR<SC,LO,GO,NO>::writeXmfVariables(){
...
template<class SC,class LO,class GO,class NO>
void ExporterParaViewAMR<SC,LO,GO,NO>::writeXmfTime(double time, double dt){
...
template<class SC,class LO,class GO,class NO>
void ExporterParaViewAMR<SC,LO,GO,NO>::prepareVectorField(MultiVecConstPtr_Type &u,
...
template<class SC,class LO,class GO,class NO>
void ExporterParaViewAMR<SC,LO,GO,NO>::prepareScalar(MultiVecConstPtr_Type &u,
...
template<class SC,class LO,class GO,class NO>
void ExporterParaViewAMR<SC,LO,GO,NO>::makePostfix(){
