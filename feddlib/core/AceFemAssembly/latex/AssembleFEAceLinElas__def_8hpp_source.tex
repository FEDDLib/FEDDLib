\hypertarget{AssembleFEAceLinElas__def_8hpp_source}{}\doxysection{Assemble\+FEAce\+Lin\+Elas\+\_\+def.\+hpp}
\label{AssembleFEAceLinElas__def_8hpp_source}\index{specific/AssembleFEAceLinElas\_def.hpp@{specific/AssembleFEAceLinElas\_def.hpp}}
\mbox{\hyperlink{AssembleFEAceLinElas__def_8hpp}{Go to the documentation of this file.}}
\begin{DoxyCode}{0}
\DoxyCodeLine{1 \textcolor{preprocessor}{\#ifndef ASSEMBLEFEACELINELAS\_DEF\_hpp}}
\DoxyCodeLine{2 \textcolor{preprocessor}{\#define ASSEMBLEFEACELINELAS\_DEF\_hpp}}
\DoxyCodeLine{3 }
\DoxyCodeLine{4 \textcolor{preprocessor}{\#include "{}\mbox{\hyperlink{AssembleFEAceLinElas__decl_8hpp}{AssembleFEAceLinElas\_decl.hpp}}"{}}}
\DoxyCodeLine{5 \textcolor{preprocessor}{\#include "{}\mbox{\hyperlink{NeoHookQuadraticTets_8hpp}{feddlib/core/AceFemAssembly/AceInterface/NeoHookQuadraticTets.hpp}}"{}}}
...
\DoxyCodeLine{23 \mbox{\hyperlink{classFEDD_1_1AssembleFEAceLinElas_a169d692dd8427dd0942e8bb47bf780bb}{AssembleFEAceLinElas<SC,LO,GO,NO>::AssembleFEAceLinElas}}(\textcolor{keywordtype}{int} flag, vec2D\_dbl\_Type nodesRefConfig, ParameterListPtr\_Type params,tuple\_disk\_vec\_ptr\_Type tuple):}
...
\DoxyCodeLine{25 \{}
\DoxyCodeLine{27     \mbox{\hyperlink{classFEDD_1_1AssembleFEAceLinElas_a1d1377442cbb6c6c9a262c679fe24a6d}{E\_}} = this-\/>\mbox{\hyperlink{classFEDD_1_1AssembleFE_a1b7f9f820f3da30ff7dd8438ada14b3b}{params\_}}-\/>sublist(\textcolor{stringliteral}{"{}Parameter"{}}).get(\textcolor{stringliteral}{"{}E"{}},3500.0); \textcolor{comment}{// the last value is the dafault value, in case no parameter is set}}
\DoxyCodeLine{28     \textcolor{comment}{//lambda\_ = this-\/>params\_-\/>sublist("{}Parameter"{}).get("{}lambda"{},1.);}}
\DoxyCodeLine{29     \mbox{\hyperlink{classFEDD_1_1AssembleFEAceLinElas_ac2b871a0e70731e39e90f8a662f2a90b}{poissonRatio\_}} = this-\/>\mbox{\hyperlink{classFEDD_1_1AssembleFE_a1b7f9f820f3da30ff7dd8438ada14b3b}{params\_}}-\/>sublist(\textcolor{stringliteral}{"{}Parameter"{}}).get(\textcolor{stringliteral}{"{}Poisson Ratio"{}},0.4e-\/0);}
\DoxyCodeLine{30 }
\DoxyCodeLine{33     \mbox{\hyperlink{classFEDD_1_1AssembleFEAceLinElas_a0492e878d36ff3f506f41296104fce85}{FEType\_}} = std::get<1>(this-\/>\mbox{\hyperlink{classFEDD_1_1AssembleFE_afd156e8e0ad2ca015a604290919d5794}{diskTuple\_}}-\/>at(0)); \textcolor{comment}{// FEType of Disk}}
\DoxyCodeLine{34     \mbox{\hyperlink{classFEDD_1_1AssembleFEAceLinElas_ac11649cdc3bfce6c6bf11a7741d73f93}{dofs\_}} = std::get<2>(this-\/>\mbox{\hyperlink{classFEDD_1_1AssembleFE_afd156e8e0ad2ca015a604290919d5794}{diskTuple\_}}-\/>at(0)); \textcolor{comment}{// Degrees of freedom per node}}
\DoxyCodeLine{35     \mbox{\hyperlink{classFEDD_1_1AssembleFEAceLinElas_a127ed400a693930e59db8e8917457058}{numNodes\_}} = std::get<3>(this-\/>\mbox{\hyperlink{classFEDD_1_1AssembleFE_afd156e8e0ad2ca015a604290919d5794}{diskTuple\_}}-\/>at(0)); \textcolor{comment}{// Number of nodes of element}}
\DoxyCodeLine{36 }
\DoxyCodeLine{37     \mbox{\hyperlink{classFEDD_1_1AssembleFEAceLinElas_ab253bad01777a594f6fc573033e7c8f2}{dofsElement\_}} = \mbox{\hyperlink{classFEDD_1_1AssembleFEAceLinElas_ac11649cdc3bfce6c6bf11a7741d73f93}{dofs\_}}*\mbox{\hyperlink{classFEDD_1_1AssembleFEAceLinElas_a127ed400a693930e59db8e8917457058}{numNodes\_}}; \textcolor{comment}{// "{}Dimension of return matrix"{}}}
\DoxyCodeLine{38 }
\DoxyCodeLine{39 \}}
\DoxyCodeLine{40 }
...
\DoxyCodeLine{50 \textcolor{keywordtype}{void} \mbox{\hyperlink{classFEDD_1_1AssembleFEAceLinElas_add6ab93bc8afae1b9ee095a05d6d8207}{AssembleFEAceLinElas<SC,LO,GO,NO>::assembleJacobian}}() \{}
\DoxyCodeLine{51 }
\DoxyCodeLine{52 }
\DoxyCodeLine{53     \mbox{\hyperlink{classFEDD_1_1AssembleFEAceLinElas_a0c4c3a54ad4f66ba78be9b76bf2eb88e}{SmallMatrixPtr\_Type}} elementMatrix =Teuchos::rcp( \textcolor{keyword}{new} \mbox{\hyperlink{classFEDD_1_1AssembleFEAceLinElas_a79448b7ba52deb3ad593eb4eae5f0a43}{SmallMatrix\_Type}}( dofsElement\_)); \textcolor{comment}{// Matrix we fill with entries.}}
\DoxyCodeLine{54 }
\DoxyCodeLine{55     assemblyLinElas(elementMatrix); \textcolor{comment}{// Function that fills the matrix. We pass though a pointer that will be filled.}}
\DoxyCodeLine{56 }
...
\DoxyCodeLine{68 \textcolor{keywordtype}{void} \mbox{\hyperlink{classFEDD_1_1AssembleFEAceLinElas_ae3f434b020e2572943dad222828c4e92}{AssembleFEAceLinElas<SC,LO,GO,NO>::assemblyLinElas}}(\mbox{\hyperlink{classFEDD_1_1AssembleFEAceLinElas_a0c4c3a54ad4f66ba78be9b76bf2eb88e}{SmallMatrixPtr\_Type}} \&elementMatrix) \{}
\DoxyCodeLine{69 }
...
\DoxyCodeLine{115 \textcolor{comment}{        std::cout << std::setprecision(767) << s[i] << std::endl;*/}}
\DoxyCodeLine{116 }
...
\DoxyCodeLine{132 \textcolor{keywordtype}{void} \mbox{\hyperlink{classFEDD_1_1AssembleFEAceLinElas_aaff921aef7a0142ba85ae59cab9debb0}{AssembleFEAceLinElas<SC,LO,GO,NO>::assembleRHS}}() \{}
\DoxyCodeLine{133 }
