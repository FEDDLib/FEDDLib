...
/*!
 ...
 \brief Constructor for  AssembleFE_NonLinElas2
...
template <class SC, class LO, class GO, class NO>
void  AssembleFE_NonLinElas2<SC,LO,GO,NO>::assembleJacobian() {
...
*/
template <class SC, class LO, class GO, class NO>
void  AssembleFE_NonLinElas2<SC,LO,GO,NO>::assemblyNonLinElas(SmallMatrixPtr_Type &elementMatrix) {
...
*/
template <class SC, class LO, class GO, class NO>
void  AssembleFE_NonLinElas2<SC,LO,GO,NO>::assembleRHS() {
...
template <class SC, class LO, class GO, class NO>
void  AssembleFE_NonLinElas2<SC,LO,GO,NO>:: updateParameter(std::string type, double value){
	if(type == "E")
		this->E_ = value;
