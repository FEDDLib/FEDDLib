      module c_routines3
        ...
        implicit none
      contains
        subroutine skr3(v,d,ul,ul0,xl,s,p,ht,hp) bind(c,name='skr3')
            implicit NONE
            real(c_double), intent(inout) :: v(1066)
        ...
        subroutine spp3(v,d,ul,ul0,xl,s,p,ht,hp,sg,sg0,sxd,gpost,npost)
     &  bind(c,name='spp3')
            implicit NONE
            real(c_double), intent(inout) :: v(1066)
            real(c_double), intent(inout) :: d(2)
