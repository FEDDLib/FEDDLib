...
/*!
 ...
 @param[in] v Working vector for AceGen, size fixed to 1002
 ...
 */
void skr1(double* v, double* d, double* ul, double* ul0, double* xl, double* s, double* p, double* ht, double* hp);
 ...
 */
void spp1(double* v, double* d, double* ul, double* ul0, double* xl, double* s, double* p, double* ht, double* hp, double* sg, double* sg0, double* sxd, double* gpost, double* npost);
#ifdef __cplusplus
}
#endif// __cplusplus
